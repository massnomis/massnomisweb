...
from apps import builder,midnovSUSHI,THORCHAINMIDNOV,testt,levanaspecial,MINELUNA,earlynovTHOR,minestaking,defilamatry1,aave29,beth,FlipsideValidator,flashy,aaavemidoctoberbatch,thorchain,aave_migration,bluna,compare,eth_fees,eth_matic_vol,extra,GPdata,gpusers,home,loop1,loop2,polygon_fees,steth
...
app.add_app("THORCHAINMIDNOVTHORCHAINMIDNOV", testt.app)

app.add_app("midnovSUSHI", midnovSUSHI.app)

app.add_app("builder", builder.app)
